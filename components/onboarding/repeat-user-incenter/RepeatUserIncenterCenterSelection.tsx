...
interface RepeatUserIncenterCenterSelectionProps {
  selectedCenterId: string;
  onCenterSelect: (centerId: string) => void;
  onNext: () => void;
}

export default function RepeatUserIncenterCenterSelection({
  selectedCenterId,
  onCenterSelect,
  onNext,
}: RepeatUserIncenterCenterSelectionProps) {
  ...
  return (
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-md mx-auto space-y-4">
        <h2 className="text-xl font-bold text-gray-900 mb-6">Select Center</h2>
        ...
        <button
          ...
          style={{ backgroundColor: selectedCenterId ? '#DDFE71' : '#9CA3AF' }}
        >
          Continue
        </button>
      </div>
