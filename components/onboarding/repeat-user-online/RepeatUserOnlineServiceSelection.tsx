...
interface RepeatUserOnlineServiceSelectionProps {
  centerId: string;
...
export default function RepeatUserOnlineServiceSelection({
  centerId,
  selectedServiceId,
  onServiceSelect,
  onBack,
}: RepeatUserOnlineServiceSelectionProps) {
  ...
  const repeatUserOnlineServices = servicesData?.services?.filter(
