...
export default function EmailCollectionModal({
  ...
  const [updatePatient, { loading: isUpdating }] = useMutation(UPDATE_PATIENT);
      ...
      <div className="bg-white rounded-2xl max-w-md w-full p-6 max-h-[90vh] overflow-y-auto border-8 border-red-500">
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className={`w-full p-3 border-2 rounded-xl focus:outline-none ${error ? 'border-red-300' : 'border-gray-200 focus:border-blue-500'
              }`}
